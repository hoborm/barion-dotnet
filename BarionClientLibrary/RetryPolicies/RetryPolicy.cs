...
public abstract class RetryPolicy : IRetryPolicy
{
    ...
    private static bool IsTransient(Exception ex)
    {
        ...
        var webException = httpRequestException != null ? httpRequestException.InnerException as WebException : ex as WebException;
        if (webException != null)
        {
            return webExceptionStatus.Contains(webException.Status);
        }

        var socketException = httpRequestException != null ? httpRequestException.InnerException as SocketException : ex as SocketException;
