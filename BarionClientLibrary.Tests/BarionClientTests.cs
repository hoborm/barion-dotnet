...
public class BarionClientTests
{
    ...
    public async Task ExecuteAsync_ShouldSendHttpRequest()
    {
        ...
        _ = await _barionClient.ExecuteAsync(new StartPaymentOperation());
    ...
    public async Task ExecuteAsync_ShouldRetrySending_IfPolicyIndicates_AfterAnException()
    {
        ...
        _ = await Assert.ThrowsAsync<Exception>(async () => await _barionClient.ExecuteAsync(new StartPaymentOperation()).ConfigureAwait(false));

        Assert.Equal(4, _httpMessageHandler.SendAsyncCallCount);
    }

    public static object[][] GetHttpMethods = [[HttpMethod.Post], [HttpMethod.Put]];
    ...
    public async Task ExecuteAsync_ShouldSetValidPOSKey(HttpMethod httpMethod)
    {
        ...
        _ = await _barionClient.ExecuteAsync(operation);
    ...
    public async Task ExecuteAsync_ShouldSerializeEnumsTo_String()
    {
        ...
        _ = PrepareValidOperation(operation);
    ...
    public async Task ExecuteAsync_ShouldSerialize_CultureInfo()
    {
        ...
        operation.MethodReturns = HttpMethod.Post;
        _httpMessageHandler.HttpResponseMessage = PrepareValidResponse();
        _ = await _barionClient.ExecuteAsync<TestOperationResult>(operation);
    ...
    public async Task ExecuteAsync_ShouldNotAllowNumberAsAnEnum()
    {
        ...
        _ = await Assert.ThrowsAsync<JsonSerializationException>(async () => await _barionClient.ExecuteAsync<TestOperationResult>(operation).ConfigureAwait(false));
    }
    ...
    public async Task BarionClient_ShouldThrowException_IfAlreadyDisposed()
    {
        ...
        _ = await Assert.ThrowsAsync<ObjectDisposedException>(async () => await _barionClient.ExecuteAsync(operation).ConfigureAwait(false));
    }
    ...
    public void BarionClient_ShouldThrowException_IfBaseUrl_IsRelative()
    {
        ...
        _ = Assert.Throws<ArgumentException>(() => new BarionClient(_barionClientSettings));
    }

    [Fact]
    public void BarionClient_ShouldThrowException_IfSettings_IsNull()
    {
        _ = Assert.Throws<ArgumentNullException>(() => new BarionClient(null));
    }
    ...
    public void BarionClient_ShouldThrowException_IfBaseUrl_IsNull()
    {
        ...
        _ = Assert.Throws<ArgumentNullException>(() => new BarionClient(_barionClientSettings));
    }
    ...
    public void BarionClient_ShouldThrowException_IfHttpClient_IsNull()
    {
        ...
        _ = Assert.Throws<ArgumentNullException>(() => new BarionClient(_barionClientSettings, null));
    }

    private static HttpResponseMessage PrepareValidResponse()
    {
    ...
    private static TestOperation PrepareValidOperation()
    {
    ...
    private static TestOperation PrepareValidOperation(TestOperation operation)
    {
        operation.MethodReturns = HttpMethod.Get;
